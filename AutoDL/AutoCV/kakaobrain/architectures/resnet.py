...
class ResNet18(models.ResNet):
    ...
    def __init__(self, in_channels, num_classes=10, **kwargs):
        ...
        self.fc1 = torch.nn.Linear(self.last_channels, self.last_channels//self.shrinkage_param, bias=True)
        self.fc = torch.nn.Linear(self.last_channels//self.shrinkage_param, num_classes, bias=False)
        self._half = False
